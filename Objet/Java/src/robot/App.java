...
public class App {
	...
	public static void main(String[] args) {
		...
		mixer.scan(); // parce que pourquoi pas, un mixeur avec scan d'ingrédients par exemple
		boolean testMixer3 = mixer.takeObject(); // renverra false, un mixeur ne peut saisir un objet
		String testAction4 = mixer.agir(); // le robot cuisinier peut agir et préparer un plat
	}
