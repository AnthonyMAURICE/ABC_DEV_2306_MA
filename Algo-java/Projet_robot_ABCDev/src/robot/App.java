...
public class App {
	...
	public static void main(String[] args) {
		...
		//variables de test
		boolean test1, test2, test3, test4, test5, test6, test7, test8, test9, test10, test11, test12, testMixer, testMixer2;
		int posX, posY;
		...
		posX = cylon.getPosX(); // retour des positions du cylon sur les axes x et y pour vérifier qu'il se déplace sur les bons axes suite aux rotations
		posY = cylon.getPosY();
